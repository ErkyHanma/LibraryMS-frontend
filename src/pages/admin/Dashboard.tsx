          ...
          <div className="flex w-full flex-col gap-4 lg:max-w-[60%]">
                      ...
                      <div className="relative min-w-0 flex-1">
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <div className="flex shrink flex-col items-center gap-2">
                            <button className="cursor-pointer rounded bg-gray-200 p-2 text-xs font-medium text-gray-600 transition duration-100 hover:bg-gray-300">
            ...
            <section className="flex max-h-50 w-full flex-col rounded-lg bg-white px-4 py-4 shadow-sm">
              <div className="mb-4 flex w-full items-center justify-between">
                ...
                <button className="text-primary cursor-pointer rounded-md bg-gray-50 px-2 py-1 text-sm font-medium shadow transition-colors duration-100 hover:opacity-65 active:scale-95">
                  View All
                </button>
              </div>
